...
<form method="post" action="home.php">
  ...
  <nav>
        ...
        <li><a href="home.php" class="active">Home</a></li>
          ...
          <li><a href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart <span>
            ...
            <li><a href="#" name="log" onclick="Log()"><i class="fa fa-user"></i>
            <?php echo ($log); ?></a></li>
        </ul>
      ...
      <section class="sec-text" data-aos="fade-right">
  ...
  <section class="sec-card" data-aos="fade-left">
    ...
    <img src="../img/farm.jpg"/>
      <div class="about-text">
        ...
        <section class="sec-service" data-aos="fade-up-right">
